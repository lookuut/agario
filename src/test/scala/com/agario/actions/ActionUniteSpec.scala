...
class ActionUniteSpec extends BaseSpec {
  ...
  "Test ttfFragments" in {
    val world = getWorld()
    val fragments = Map(
      "1" -> new Fragment(world, "1", new Circle(new Point(100, 100), 40 / math.sqrt(40)), 40.0, new Point(0, 0), 10),
      "2" -> new Fragment(world, "2", new Circle(new Point(120, 120), 40 / math.sqrt(40)), 40.0, new Point(0, 0), 10)
    )
